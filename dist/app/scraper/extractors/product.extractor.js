...
exports.ProductExtractor = {
    ...
    extract($, baseUrl, selectors) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Extract title
            const titleSelector = (selectors === null || selectors === void 0 ? void 0 : selectors.title) || defaultSelectors.title;
            ...
            // Extract price
            const priceSelector = (selectors === null || selectors === void 0 ? void 0 : selectors.price) || defaultSelectors.price;
            ...
            const originalPriceSelector = (selectors === null || selectors === void 0 ? void 0 : selectors.originalPrice) || defaultSelectors.originalPrice;
            ...
            // Extract images
            const imageSelector = (selectors === null || selectors === void 0 ? void 0 : selectors.images) || defaultSelectors.images;
            const images = [];
            const seenImages = new Set();
            $(imageSelector).each((_, el) => {
                const $img = $(el);
                let src = $img.attr('data-old-hires') || // Amazon high-res
            ...
            // Extract description
            const descSelector = (selectors === null || selectors === void 0 ? void 0 : selectors.description) || defaultSelectors.description;
            let description = '';
            ...
            // Extract rating
            const ratingSelector = (selectors === null || selectors === void 0 ? void 0 : selectors.rating) || defaultSelectors.rating;
            ...
            const reviewSelector = (selectors === null || selectors === void 0 ? void 0 : selectors.reviewCount) || defaultSelectors.reviewCount;
            ...
            const availSelector = (selectors === null || selectors === void 0 ? void 0 : selectors.availability) || defaultSelectors.availability;
            ...
            if (isEbay && 'condition' in defaultSelectors) {
                const conditionSelector = defaultSelectors.condition;
            ...
            if (isEbay && 'seller' in defaultSelectors) {
                const sellerSelector = defaultSelectors.seller;
            ...
            if (isAliExpress && 'shipping' in defaultSelectors) {
                const shippingSelector = defaultSelectors.shipping;
            ...
            if (isWalmart) {
                ...
                try {
                    ...
                    if (nextDataScript) {
                        ...
                        const productData = ((_d = (_c = (_b = (_a = nextData === null || nextData === void 0 ? void 0 : nextData.props) === null || _a === void 0 ? void 0 : _a.pageProps) === null || _b === void 0 ? void 0 : _b.initialData) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.product)
                            || ((_f = (_e = nextData === null || nextData === void 0 ? void 0 : nextData.props) === null || _e === void 0 ? void 0 : _e.pageProps) === null || _f === void 0 ? void 0 : _f.product)
                            || {};
                        ...
                        if ((_h = (_g = productData.priceInfo) === null || _g === void 0 ? void 0 : _g.currentPrice) === null || _h === void 0 ? void 0 : _h.price) {
                        ...
                        if (!((_j = product.images) === null || _j === void 0 ? void 0 : _j.length) && ((_k = productData.imageInfo) === null || _k === void 0 ? void 0 : _k.allImages)) {
                ...
                if (currentPrice === null || !((_l = product.images) === null || _l === void 0 ? void 0 : _l.length)) {
                    $('script[type="application/ld+json"]').each((_, script) => {
                        var _a, _b, _c, _d;
                        try {
                            const jsonText = $(script).html();
                            if (jsonText) {
                                ...
                                for (const item of items) {
                                    if (item['@type'] === 'Product') {
                                        ...
                                        if (currentPrice === null && ((_a = item.offers) === null || _a === void 0 ? void 0 : _a.price)) {
                                        ...
                                        if (!((_b = product.images) === null || _b === void 0 ? void 0 : _b.length) && item.image) {
                                            product.images = Array.isArray(item.image) ? item.image.slice(0, 20) : [item.image];
                                        }
                                        if (!product.rating && ((_c = item.aggregateRating) === null || _c === void 0 ? void 0 : _c.ratingValue)) {
                                            product.rating = parseFloat(item.aggregateRating.ratingValue);
                                        }
                                        if (!product.brand && ((_d = item.brand) === null || _d === void 0 ? void 0 : _d.name)) {
            ...
            if (isTarget) {
                ...
                if (currentPrice === null || !((_m = product.images) === null || _m === void 0 ? void 0 : _m.length)) {
                    $('script[type="application/ld+json"]').each((_, script) => {
                        var _a, _b, _c, _d;
                        try {
                            const jsonText = $(script).html();
                ...
                if (currentPrice === null || !((_o = product.images) === null || _o === void 0 ? void 0 : _o.length)) {
                    try {
                        ...
                        if (tgtStateScript) {
                            ...
                            if (stateMatch) {
                                ...
                                const productDetails = ((_p = tgtState === null || tgtState === void 0 ? void 0 : tgtState.product) === null || _p === void 0 ? void 0 : _p.details) || {};
                                if (!product.title && productDetails.title) {
                                    product.title = productDetails.title;
                                }
                                if (currentPrice === null && ((_q = productDetails.price) === null || _q === void 0 ? void 0 : _q.current_retail)) {
            ...
            // Extract features
            const featuresSelector = (selectors === null || selectors === void 0 ? void 0 : selectors.features) || defaultSelectors.features;
            const features = [];
            ...
            // Extract brand
            const brandSelector = ((_r = selectors === null || selectors === void 0 ? void 0 : selectors.custom) === null || _r === void 0 ? void 0 : _r.brand) || defaultSelectors.brand;
