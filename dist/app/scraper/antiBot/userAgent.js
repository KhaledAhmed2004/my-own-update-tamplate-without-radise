...
exports.userAgentHelper = exports.getAllUserAgents = exports.getDefaultUserAgent = exports.getUserAgentByBrowser = exports.getRandomUserAgent = void 0;
 ...
 */
const getUserAgentByBrowser = (browser = 'chrome') => {
    let agents;
    switch (browser) {
        case 'chrome':
...
exports.getUserAgentByBrowser = getUserAgentByBrowser;
/**
 ...
 */
const getAllUserAgents = () => {
    return [...ALL_USER_AGENTS];
};
exports.getAllUserAgents = getAllUserAgents;
exports.userAgentHelper = {
    getRandomUserAgent: exports.getRandomUserAgent,
    getUserAgentByBrowser: exports.getUserAgentByBrowser,
    getDefaultUserAgent: exports.getDefaultUserAgent,
    getAllUserAgents: exports.getAllUserAgents,
};
