...
exports.isFingerprintSpoofingAvailable = isFingerprintSpoofingAvailable;
 ...
 */
function injectFingerprintSpoofing(page) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            logger_1.logger.debug('[Fingerprint] Spoofing scripts injected successfully');
        }
        catch (error) {
            // Log but don't throw - this is optional enhancement
            logger_1.logger.debug(`[Fingerprint] Failed to inject spoofing scripts: ${error.message}`);
        }
    });
}
/**
 ...
 */
function isFingerprintSpoofingAvailable() {
    return true;
}
