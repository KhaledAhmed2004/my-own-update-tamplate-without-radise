...
exports.createPreferenceCardSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        supplies: zod_1.z.array(zod_1.z.string()).min(1),
        sutures: zod_1.z.array(zod_1.z.string()).min(1),
        ...
        photoLibery: zod_1.z.array(zod_1.z.string()).optional(),
...
exports.updatePreferenceCardSchema = zod_1.z.object({
    ...
    body: zod_1.z.object({
        ...
        sutures: zod_1.z.array(zod_1.z.string()).optional(),
