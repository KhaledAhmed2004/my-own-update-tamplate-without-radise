...
exports.SuppliesController = {
    ...
    listSupplies: (0, catchAsync_1.default)((_req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield supplies_service_1.SuppliesService.listSuppliesFromDB();
        (0, sendResponse_1.default)(res, {
            success: true,
            statusCode: http_status_codes_1.StatusCodes.OK,
