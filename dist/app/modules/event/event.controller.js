...
const createEvent = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Trigger notification: Event Scheduled
    try {
        const date = result.date ? new Date(result.date) : undefined;
        const time = result.time;
        const whenText = date && time
            ? `${date.toISOString().slice(0, 10)} at ${time}`
            : undefined;
        yield notification_service_1.NotificationService.createForEventScheduled({
            userId: user.id,
            eventId: ((_b = (_a = result._id) === null || _a === void 0 ? void 0 : _a.toString) === null || _b === void 0 ? void 0 : _b.call(_a)) || result.id,
            title: result.title,
            whenText,
        });
    }
